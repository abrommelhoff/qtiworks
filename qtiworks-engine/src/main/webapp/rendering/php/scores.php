...
function getUsers($dbname)
{
	...
	$result = mysql_query("select response_correctness, string_data, xrid, xeid, misconception_type, misconception_value from candidate_responses left outer join candidate_string_response_items on candidate_string_response_items.xrid=candidate_responses.xrid;");
