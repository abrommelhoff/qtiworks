...
if (!$getResponse) { 
	...
	echo '<table><tr><td>identifier</td><td>timestamp</td><td>timeontask</td><td>misconception type</td><td>misconception value</td><td>correctness</td><td>string response</td><td>score</td></tr>';
